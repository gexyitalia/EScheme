...
public class ESFrameTitleBar extends JPanel{
	/**
	 * 
	 */
	...
	protected boolean dragable; //se il drag � permesso
	 ...
	 * @param _dragable
	 */
	public ESFrameTitleBar(final JFrame _parent, String _title, boolean _minimizeable, boolean _maximizeable, boolean _closeable, boolean _dragable){
		this.parent = _parent;
