...
public class ESTaddedPaneUI extends BasicTabbedPaneUI {
	...
	public static ComponentUI createUI(JComponent c) {
		return new ESTaddedPaneUI();
	}

	public ESTaddedPaneUI() {
		...
		defaultColorSet.topGradColor1 = new Color(242, 242, 242);
		defaultColorSet.topGradColor2 = new Color(242, 242, 242);

		defaultColorSet.bottomGradColor1 = new Color(242, 242, 242);
		defaultColorSet.bottomGradColor2 = new Color(242, 242, 242);

		hoverColorSet = new ColorSet();
		hoverColorSet.topGradColor1 = new Color(242, 242, 242);
		hoverColorSet.topGradColor2 = new Color(242, 242, 242);

		hoverColorSet.bottomGradColor1 = new Color(242, 242, 242);
		hoverColorSet.bottomGradColor2 = new Color(242, 242, 242);
	...
	protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
		...
		g2d.fillRect(0, 0, tabPane.getWidth(), 9);
