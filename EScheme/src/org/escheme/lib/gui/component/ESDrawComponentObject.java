...
public class ESDrawComponentObject {
	//Contengono le coordinate per disegnare l'oggetto
	public ArrayList<Point> areaPoints = new ArrayList<Point>();
	...
	public ESDrawComponentObject(ArrayList<Point> _areaPoints,int _type,String _text){
		areaPoints=_areaPoints;
		text=_text;
		type=_type;
	}
	
	public ESDrawComponentObject(){}
